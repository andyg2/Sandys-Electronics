...
const CONVENTIONS = [
  ...
  '',
  'AUDIENCE:',
  '- Target reader is a 10-year-old building with his dad. Default to kid-readable explanations (5th grade).',
  '- NO SOLDERING. All projects must work on the breadboard. The Double-Sided Prototype PCB is currently off the menu.',
  '- Projects must have visible / audible / movement feedback the kid can react to. No silent bench tools, no unloaded power supplies, no calibration jigs.',
  '',
  'CONSTRAINTS:',
